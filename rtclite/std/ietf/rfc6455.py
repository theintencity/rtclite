...
verify_handshake and userdata arguments as follows.
  ...
  def verify_handshake(userdata=None, path='/', headers=None):
    ...
Here path is from the request line and headers is of type MIMEMessage. The function
...
import sys, traceback, random, logging, re, struct, base64, uuid, hashlib, urllib.parse, ssl, _thread, time, socket, socketserver
...
def receive_handshake(msg, verify_handshake=None, userdata=None):
    ...
    except HTTPError as e: return (str(e), msg, '') # send error response
...
class WebSocket(object):
    ...
    def connect(self, url):
        ...
        self.thread = _thread.start_new_thread(func, (self, url))
...
def echo_server(options):
    ...
    for typ, host, port in listen:
        ...
        th = _thread.start_new_thread(serve_forever, (), args)
